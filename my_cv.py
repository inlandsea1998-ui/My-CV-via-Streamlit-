...
""")
        st.image(["스프레드시트실무2급.png", "프레젠테이션실무2급.png"])
...
Developed analytical thinking, data interpretation, and human-centered problem-solving skills.""")
        st.image(["졸업증명서.png", "academic_record.png"], caption=["졸업증명서", "Academic Record"])
...
""")
        st.image(["재학증명서_AI전공.png", "성적증명서_AI전공.png"])
